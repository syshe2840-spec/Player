...
LinearGradient _extGrad(String ext){
  switch(ext){
    ...
    default:    return const LinearGradient(colors:[Color(0xFF1A1A1A),Color(0xFF0A0A0A)]);
  }
}
  ...
  @override Widget build(BuildContext context)=>GestureDetector(
    ...
    child:Container(margin:const EdgeInsets.only(bottom:6),padding:const EdgeInsets.symmetric(horizontal:14,vertical:12),
      ...
      child:Row(children:[
        ...
        const Icon(Icons.arrow_back_ios_new_rounded,color:kTextDim,size:20),
      ]),
    ),
  );
}
            ...
            ClipRRect(
              ...
              child:selectMode
                  ?AnimatedContainer(duration:const Duration(milliseconds:150),width:48,height:48,
                      ...
                      child:Icon(selected?Icons.check_circle_rounded:Icons.circle_outlined,color:Colors.white,size:20))
