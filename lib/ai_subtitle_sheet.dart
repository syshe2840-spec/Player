  ...
  List<Widget> _buildPick()=>[
          ...
          Row(children:[
            ...
            if(improved)...[
              ...
              Container(padding:const EdgeInsets.symmetric(horizontal:6,vertical:2),
                ...
                child:Text(L.improved,style:TextStyle(color: const Color(0xFF7C3AED),fontSize:10))),
            ],
          ]),
          const SizedBox(height:8),
          Row(children:[
    ...
    Row(children:[
      Expanded(child:OutlinedButton.icon(
        ...
        label:Text(L.createNewLang,style:TextStyle(color: const Color(0xFF7C3AED),fontSize:13)),
  ...
  List<Widget> _buildDone()=>[
    ...
    Row(children:[
      Expanded(child:OutlinedButton.icon(
        ...
        label:Text(L.share,style:TextStyle(color: const Color(0xFF7C3AED),fontSize:12,fontWeight:FontWeight.bold)),
        style:OutlinedButton.styleFrom(side:const BorderSide(color: const Color(0xFF7C3AED)),
